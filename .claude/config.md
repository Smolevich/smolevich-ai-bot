...
- DB: `/var/lib/telegram-llm-bot.db` — shared between the bot and the health-check cron
...
- `BOT_PROXY_URL` — SOCKS proxy for providers with geo restrictions (Groq, Cerebras).
