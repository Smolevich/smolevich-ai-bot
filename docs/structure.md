...
- `bot/smolevich-ai-bot.py` — the bot itself (~1250+ lines): Telegram long-poll/webhook, SQLite, providers (OpenRouter / Groq / NVIDIA), Podman sessions, STT/TTS handlers. Holds the global acpx lock for user sessions.
